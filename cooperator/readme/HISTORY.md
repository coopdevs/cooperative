...
- Allow to pay capital release requests in the portal.
  ([\#163](https://github.com/OCA/cooperative/issues/163))

**Bugfixes**

- Fix rare access error that can happen when querying share types.
  ([\#163](https://github.com/OCA/cooperative/issues/163))
...
- Ensure that the birthdate field of subscription requests has at least
  4 digits and is not in the future.
  ([\#176](https://github.com/OCA/cooperative/issues/176))

## 16.0.1.2.4 (2025-11-12)

**Bugfixes**

- Rename obsolete occurrences of the `blocked` `subscription.request`
  state still present as `block`.
  ([\#150](https://github.com/OCA/cooperative/issues/150))
...
- Fix display of image fields in settings.
  ([\#171](https://github.com/OCA/cooperative/issues/171))
...
- Use image widget for `signature_scan`.
  ([\#170](https://github.com/OCA/cooperative/issues/170))
...
- Fix transfer operation to non-member: update share fields values of
  the internal subscription request of a transfer operation to a
  non-member when these values are changed in the form. This ensures
  that the values are correct even if the subscription request is
  created before the values are set.
  ([\#162](https://github.com/OCA/cooperative/issues/162))

## 16.0.1.2.0 (2025-09-17)

**Features**

- Move settings from company form to main settings.
  ([\#140](https://github.com/OCA/cooperative/issues/140))
...
- Fix tests with a localization module: previously, when initializing a
  ...
  account chart template from that module. Now, it doesn't use any. Fix
  the tests by loading the first chart template found on the default
  company. ([\#161](https://github.com/OCA/cooperative/issues/161))
...
- Fix computation of name of subscription requests for companies when
  ...
  ([\#144](https://github.com/OCA/cooperative/issues/144))

## 16.0.1.1.0 (2024-05-06)

**Deprecations and Removals**

- Deprecate `subscription.request.get_person_info()` method in favor of
  new `.set_person_info()` method.
...
- Refactor cooperative.membership preparation code.
  ([\#101](https://github.com/OCA/cooperative/issues/101))
