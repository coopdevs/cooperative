...
- Allow to pay capital release requests in the portal.
  (`#163 <https://github.com/OCA/cooperative/issues/163>`__)
...
- Ensure that the birthdate field of subscription requests has at least
  ...
  (`#176 <https://github.com/OCA/cooperative/issues/176>`__)
...
- Rename obsolete occurrences of the ``blocked``
  ``subscription.request`` state still present as ``block``.
  (`#150 <https://github.com/OCA/cooperative/issues/150>`__)
...
- Fix display of image fields in settings.
  (`#171 <https://github.com/OCA/cooperative/issues/171>`__)
...
- Use image widget for ``signature_scan``.
  (`#170 <https://github.com/OCA/cooperative/issues/170>`__)
...
- Fix transfer operation to non-member: update share fields values of
  ...
  (`#162 <https://github.com/OCA/cooperative/issues/162>`__)
...
- Move settings from company form to main settings.
  (`#140 <https://github.com/OCA/cooperative/issues/140>`__)
...
- Fix tests with a localization module: previously, when initializing a
  ...
  company. (`#161 <https://github.com/OCA/cooperative/issues/161>`__)
...
- Fix computation of name of subscription requests for companies when
  ...
  (`#144 <https://github.com/OCA/cooperative/issues/144>`__)
...
- Deprecate ``subscription.request.get_person_info()`` method in favor
  of new ``.set_person_info()`` method.
...
- Refactor cooperative.membership preparation code.
  (`#101 <https://github.com/OCA/cooperative/issues/101>`__)
